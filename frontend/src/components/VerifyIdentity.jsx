      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col w-[512px] max-w-[512px] py-5 max-w-[960px] flex-1">
            ...
            <div className="flex px-4 py-3">
              <IDKitWidget
                app_id="app_staging_e7bc5518aa28f0a211351dbc5210d0ca"
                action="test-inifinite-verification"
                onSuccess={onSuccess}
                verification_level={VerificationLevel.Device}
              >
                {({ open }) => (
            ...
            <button 
              ...
              className="mt-4 flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 px-4 flex-1 bg-[#209cee] text-slate-50 text-sm font-bold leading-normal tracking-[0.015em]"
            >
              Sample Button
            </button>
          </div>
